...
import productLogo from '../assets/products/index';
...
const d8Products =  [
     {
      ...
      ProductLogo: productLogo.candyCane,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Sleepy",
      details: "Candy Cane is a 70% Indica strain from Crop King Seeds that combines AK-47, Mango, and White Widow genetics. Its sour, fruity taste is followed by long-lasting, euphoric effects that combat stress and tension. Candy Cane autoflowers in 7 weeks and produces moderately high yields in both indoor and outdoor gardens."
    },
    {
      name: "Tropical Melon",
      description: "Hybrid",
    ...
    },
    {
      ...
      ProductLogo: productLogo.jackHerer,
      feeling1: "Happy", 
      feeling2:  "Uplifted",
      feeling3:  "Euphoric",
    ...
    },
    {
      ...
      ProductLogo: productLogo.pricklyPineapple,
      feeling1: "Happy", 
      feeling2:  "Euphoric",
      feeling3:  "Uplifting",
      details: "Mojito is a sativa-dominant hybrid marijuana strain made by crossing Orange Blossom Trail with Limegerian. This strain produces relaxing effects that slowly turn into a gentle and cerebral body high. Mojito is a shining star when it comes to flavors and aromas, featuring bold citrus notes accompanied by floral undertones. While this strain is typically sought out for its incredible flavor profile, medical marijuana patients choose Mojito to help relieve symptoms associated with headaches, inflammation, and depression. Growers say this strain features dense, green foliage covered in burnt orange hairs. Mojito was originally bred by Swamp Boys Seeds. If you've smoked, dabbed, or consumed this strain before, tell us about your experience by leaving a review."
    },
    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.sleepy,
      ProductLogo: productLogo.sugarCookies,
      feeling1: "Uplifted", 
      feeling2:  "Happy",
      feeling3:  "Tingly",
      details: "Mojito is a sativa-dominant hybrid marijuana strain made by crossing Orange Blossom Trail with Limegerian. This strain produces relaxing effects that slowly turn into a gentle and cerebral body high. Mojito is a shining star when it comes to flavors and aromas, featuring bold citrus notes accompanied by floral undertones. While this strain is typically sought out for its incredible flavor profile, medical marijuana patients choose Mojito to help relieve symptoms associated with headaches, inflammation, and depression. Growers say this strain features dense, green foliage covered in burnt orange hairs. Mojito was originally bred by Swamp Boys Seeds. If you've smoked, dabbed, or consumed this strain before, tell us about your experience by leaving a review."
    ...
    },
    {
      ...
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.berriesAndCream,
      feeling1: "Happy", 
      feeling2:  "Relaxed",
      feeling3:  "Euphoric",
...

    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.birthdayCake,
      feeling1: "Happy", 
      feeling2:  "Relaxed",
      feeling3:  "Euphoric",
      details: "Berries and Cream, bred by Certified Portland, is an indica-dominant cross between Exotic Genetix’s Grease Monkey and Breeder Steve’s Shishkaberry. Expressing an aroma of tart fruit, blackberry thistle, and fresh waffle cone, the flavor takes on additional notes of caramelized sugar. The effects of Berries and Cream are strong, hitting behind the eyes before radiating throughout the body to provide relaxation and focusing mental clarity."
    },
    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.skittlez,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Euphoric",
    ...
    },
    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.superGlue,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Euphoric",
      details: 'Superglue, also known as "Tacky Glue," is an Indica-leaning hybrid strain that produces a functional and relaxing high to the mind and body. Smelling of pine and a sweet caramel aroma, this strain is bred by Seedism Seeds. Superglue is made by crossing Afghani and Northern Light. Those who enjoy Superglue say it relaxes you while still leaving you functional and energetic enough for social activities or even a productive afternoon.'
    },
    ...
    
    {
      ...
      ImgLink1: productIcons.relaxed,
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.hungry,
      ProductLogo: productLogo.bluberryOg,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Hungry",
      details: 'Blueberry OG is a DJ Short Blueberry phenotype with exceptional CBD yielding qualities combined with the Indica-dominant legend, OG Kush. This potent, award-winning union doesn’t pack much in the way of psychoactivity, but its anti-anxiety and anti-inflammatory effects make up for any lack of headiness. With flavors of sweet camphor and sandalwood, this strain elevates the consumer\'s mood and promotes an overall sense of well-being.'
    },
    {
      name: "Sativa Blend",
      description: "Sativa",
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.sativaBlend,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Euphoric",
      details: 'The Sativa Blend’s terpene profile is made up of 10 compounds. Beta-caryophyllene totals 30% of the profile, making it the most present in the profile. Myrcene is the second most present at 23%, while limonene (12%) and humulene (11%) make the larger portions of the profile. Meanwhile, alpha-pinene, alpha-bisabolol, beta-pinene, nerolidol, phytol, and geranyl acetate each make up 7% or less of the blend’s terpene profile. Consumers may especially pick up on beta-caryophyllene and limonene when encountering the Sativa Blend’s sweet, citrus notes.'
    },
    {
      name: "Platinum OG",
      description: "Indica",
    ...
    
    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.uplifting,
      ProductLogo: productLogo.indicaBlend,
      feeling1: "Energetic", 
      feeling2:  "Happy",
      feeling3:  "Uplifted",
      details: 'Indica Blend is a blend of our seasonal Indica strains. Indica strains are generally believed to be calming and sedative, with most people experiencing an all-over relaxed effect in both their body and mind. Specific results will vary by person, strain, and product.'
    },
        
    {
      ...
      ImgLink2: productIcons.happy,
      ImgLink3: productIcons.euphoric,
      ProductLogo: productLogo.appleFritter,
      feeling1: "Relaxed", 
      feeling2:  "Happy",
      feeling3:  "Euphoric",
      details: 'Apple Fritter, a true hybrid strain, is known for its powerful and relaxing high. Put out by Lumpy’s Flowers, Apple Fritter is a strain with secret origins. Those who enjoy Apple Fritter say this strain allows you to enjoy an evening without losing your cool. Apple Fritter has a flavor and aroma that come off as sweet and earthy, with a light cheesy apple pastry influence.'
    },
